...
namespace WmsReport.Infrastructure.Config
{
    ...
    {
        private static IWmsDbConnection _wmsDbConnection;

        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="wmsDbConnection"></param>
        public DapperHelper(
            IWmsDbConnection wmsDbConnection)
        {
        ...
        {
            using (SqlConnection con = new SqlConnection(_wmsDbConnection.GetDbConnStr("WmsReport","")))
            {
